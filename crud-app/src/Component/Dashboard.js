            ...
            <div className="layout">
                <div className="sidebar">
                    ...
                    <div className="actionBtn">
                        ...
                        <button className="active"><Link to="/add"><FontAwesomeIcon icon="pencil-alt" className="icon"/>Create Posts</Link></button>
                    </div>
                </div>
                                ...
                                <div className="cardHeader">
                                    ...
                                    <div className="subinfo">
                                        ...
                                        <div className="action">
                                            <p className="edit"><Link to={`/edit/${post._id}`}><FontAwesomeIcon icon="edit" className="icon"/>Edit</Link></p>
                                            <p className="delete" onClick={() => deletePostData(post._id)}><FontAwesomeIcon icon="trash-alt" className="icon"/>Delete</p>
                                        </div>
                                    </div>
                                </div>
